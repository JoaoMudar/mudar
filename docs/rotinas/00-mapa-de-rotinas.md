# Mapa de Rotinas por Perfil de Usuário
...
| Registro de produção (repicagem, semeadura) | Colaborador |

## 3. Tarefas Diárias (`rotina-tarefas.md`)

| Etapa | Perfil |
|-------|--------|
| Planejamento e distribuição de tarefas | Gerência |
| Lista de tarefas do dia | Colaborador |
| Marcar tarefa como concluída | Colaborador |
| Acompanhamento de execução | Gerência |

## 4. Perdas (`rotina-perdas.md`)
