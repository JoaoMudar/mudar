...
| Código | Artefato | Destino no TCC | Situação |
|---|---|---|---|
| [C1](C-modelagem/C1-diagrama-casos-de-uso.md) | Diagrama de casos de uso | 4.4 Modelagem do sistema | ✅ escrito: 44 casos de uso |
...
| [D4](D-arquitetura/D4-matriz-rbac.md) | Matriz RBAC | 4.7 Segurança e controle de acesso | ✅ escrito: 31 recursos, agrupados nos quatro módulos |

### E: Qualidade, riscos e segurança

| Código | Artefato | Destino no TCC | Situação |
|---|---|---|---|
| [E2](E-qualidade/E2-casos-de-teste-de-aceite.md) | Casos de teste de aceite | 4.8 + Apêndice | ✅ escrito: 55 casos |
