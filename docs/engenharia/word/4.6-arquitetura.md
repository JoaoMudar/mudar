...
![Figura 12: Diagrama](img/4.6-arquitetura-fig12.png)

**Figura 12**: Diagrama. Fonte: elaborado pelo autor (2026).
...
![Figura 13: Diagrama](img/4.6-arquitetura-fig13.png)

**Figura 13**: Diagrama. Fonte: elaborado pelo autor (2026).
...
![Figura 14: Diagrama](img/4.6-arquitetura-fig14.png)

**Figura 14**: Diagrama. Fonte: elaborado pelo autor (2026).
