...
![Figura 7 — Acesso](img/4.4-modelagem-de-dados-fig07.png)

**Figura 7** — Acesso. Fonte: elaborado pelo autor (2026).
...
![Figura 8 — Núcleo e custeio](img/4.4-modelagem-de-dados-fig08.png)

**Figura 8** — Núcleo e custeio. Fonte: elaborado pelo autor (2026).
...
![Figura 9 — Operação — produção, perdas e estoque](img/4.4-modelagem-de-dados-fig09.png)

**Figura 9** — Operação — produção, perdas e estoque. Fonte: elaborado pelo autor (2026).
...
![Figura 10 — Comercial](img/4.4-modelagem-de-dados-fig10.png)

**Figura 10** — Comercial. Fonte: elaborado pelo autor (2026).
...
![Figura 11 — Fornecedores](img/4.4-modelagem-de-dados-fig11.png)

**Figura 11** — Fornecedores. Fonte: elaborado pelo autor (2026).
...
![Figura 12 — Financeiro](img/4.4-modelagem-de-dados-fig12.png)

**Figura 12** — Financeiro. Fonte: elaborado pelo autor (2026).
...
![Figura 13 — Precificação](img/4.4-modelagem-de-dados-fig13.png)

**Figura 13** — Precificação. Fonte: elaborado pelo autor (2026).
