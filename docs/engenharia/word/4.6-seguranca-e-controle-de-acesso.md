...
![Figura 21 — Onde a verificação ocorre](img/4.6-seguranca-e-controle-de-acesso-fig21.png)

**Figura 21** — Onde a verificação ocorre. Fonte: elaborado pelo autor (2026).
