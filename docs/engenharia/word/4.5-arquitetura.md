...
![Figura 15 — Nível 1 — Contexto](img/4.5-arquitetura-fig15.png)

**Figura 15** — Nível 1 — Contexto. Fonte: elaborado pelo autor (2026).
...
![Figura 16 — Nível 2 — Contêineres](img/4.5-arquitetura-fig16.png)

**Figura 16** — Nível 2 — Contêineres. Fonte: elaborado pelo autor (2026).
...
![Figura 17 — Nível 3 — Componentes da camada de lógica](img/4.5-arquitetura-fig17.png)

**Figura 17** — Nível 3 — Componentes da camada de lógica. Fonte: elaborado pelo autor (2026).
...
![Figura 18 — Topologia de produção](img/4.5-arquitetura-fig18.png)

**Figura 18** — Topologia de produção. Fonte: elaborado pelo autor (2026).
...
![Figura 19 — Dois ambientes](img/4.5-arquitetura-fig19.png)

**Figura 19** — Dois ambientes. Fonte: elaborado pelo autor (2026).
...
![Figura 20 — Publicação e migração de esquema](img/4.5-arquitetura-fig20.png)

**Figura 20** — Publicação e migração de esquema. Fonte: elaborado pelo autor (2026).
