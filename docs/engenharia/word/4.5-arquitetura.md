...
![Figura 15 — Diagrama](img/4.5-arquitetura-fig15.png)

**Figura 15** — Diagrama. Fonte: elaborado pelo autor (2026).
...
![Figura 16 — Diagrama](img/4.5-arquitetura-fig16.png)

**Figura 16** — Diagrama. Fonte: elaborado pelo autor (2026).
...
![Figura 17 — Diagrama](img/4.5-arquitetura-fig17.png)

**Figura 17** — Diagrama. Fonte: elaborado pelo autor (2026).
...
![Figura 18 — Diagrama](img/4.5-arquitetura-fig18.png)

**Figura 18** — Diagrama. Fonte: elaborado pelo autor (2026).
...
![Figura 19 — Diagrama](img/4.5-arquitetura-fig19.png)

**Figura 19** — Diagrama. Fonte: elaborado pelo autor (2026).
...
![Figura 20 — Diagrama](img/4.5-arquitetura-fig20.png)

**Figura 20** — Diagrama. Fonte: elaborado pelo autor (2026).
