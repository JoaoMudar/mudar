...
- **Não invente identificadores.** `RN-01` a `RN-70` (regras, das quais RN-36, RN-49, RN-54, RN-60, RN-61, RN-63, RN-64, RN-65 saíram do catálogo
  e cujos números não se reutilizam), `RF-01` a `RF-76` (requisitos
...
Os 76 requisitos funcionais de `B2`. Quatro não decorrem de regra de negócio e estão justificados na
seção 6.
