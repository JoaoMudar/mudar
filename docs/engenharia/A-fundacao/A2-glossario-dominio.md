...
| **Categoria da espécie** | Classificação de uso e comportamento ecológico. Lista fechada: frutífera, ornamental, madeira, restauração, pioneira, clímax. | "tipo" | **Categoria** |
