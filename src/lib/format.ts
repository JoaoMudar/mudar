 ...
 * `fmtDate` local em varios componentes. Telas de numero formatam em quase toda
 * celula, entao vale centralizar — modulo puro, sem I/O, testado.
 */
...
/**
 * 47.4 -> "47,4%". `null` vira travessao — um percentual ausente costuma ser um
 * estado real (periodo incompleto, base parcial), nao um erro a esconder com 0%.
 */
